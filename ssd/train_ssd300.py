...
if __name__ == '__main__':
    import os
    os.chdir(r'E:\program\vscode\network\deep-learning-for-image-processing\pytorch_object_detection\ssd\\')
    print(os.getcwd())
    import argparse
    ...
    # 训练数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='E:/data/network/', help='dataset')
    # 文件保存地址
